...
void ADC_SETUP(char* str, int adc){//e.g. PA0
	...
	if(adc==2){														//if the ADC selected by user is 2
		...
		ADC2->SQR3|=getNum(str);					//set channel
	...
	if(adc==3){														//if the ADC selected by user is 3
		...
		ADC3->SQR3|=getNum(str);					//set channel
